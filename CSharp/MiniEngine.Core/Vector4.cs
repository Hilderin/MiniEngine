...
namespace MiniEngine
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        private static Vector4 _unit = new Vector4(1f, 1f, 1f, 1f);
        ...
        {
            result.X = Math.Lerp(value1.X, value2.X, amount);
            result.Y = Math.Lerp(value1.Y, value2.Y, amount);
            result.Z = Math.Lerp(value1.Z, value2.Z, amount);
            result.W = Math.Lerp(value1.W, value2.W, amount);
        }
        ...
        {
            result.X = Math.SmoothStep(value1.X, value2.X, amount);
            result.Y = Math.SmoothStep(value1.Y, value2.Y, amount);
            result.Z = Math.SmoothStep(value1.Z, value2.Z, amount);
            result.W = Math.SmoothStep(value1.W, value2.W, amount);
        }
        ...
        /// <summary>
        /// Creates a new <see cref="Vector4"/> that contains a transformation of 2d-vector by the specified <see cref="Matrix4"/>.
        /// </summary>
