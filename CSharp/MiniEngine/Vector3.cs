...
namespace MiniEngine
{
    ...
    public struct Vector3: IEquatable<Vector3>
    {
        ...
        /// Invert the vector (multiplies it by -1)
        /// </summary>
        public static Vector3 Invert(ref Vector3 vector)
        {
        ...
        /// Multiply the vector by a factor
        /// </summary>
        public static Vector3 Multiply(ref Vector3 vector, float factor)
        {
        ...
        )
        {
            ...
            result.Z = Math.Hermite(value1.Z, tangent1.Z, value2.Z, tangent2.Z, amount);
        }
        ...
        /// <summary>
        /// Implicit conversion from a vector 3 to vector 4
        /// </summary>
        public static implicit operator Vector3(Vector4 vector4)
        {
            return new Vector3(vector4);
        }
