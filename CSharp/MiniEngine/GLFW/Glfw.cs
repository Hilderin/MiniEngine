...
//#if Windows
        ...
        /// <summary>
        /// Ensure the dll exists in the folder
        /// </summary>
        private static void EnsureDllExists()
        {
            string path = Path.Combine(Path.GetDirectoryName(Assembly.GetEntryAssembly().Location), LIBRARY + ".dll");

            if (!File.Exists(path))
                File.WriteAllBytes(path, Ressources.Resources.glfw3);
        }
        ...
        public static string GetJoystickGuid(int joystickId)
        {
            ...
            return ptr == IntPtr.Zero ? null : NativeUtils.PtrToStringUtf8(ptr);
        }
        ...
        ///     The version string.
        /// </value>
        public static string VersionString => NativeUtils.PtrToStringUtf8(GetVersionString());
        ...
        {
            return NativeUtils.PtrToStringUtf8(GetJoystickNameInternal(joystick));
        }
        ...
        {
            return NativeUtils.PtrToStringUtf8(GetKeyNameInternal(key, scanCode));
        }
        ...
        {
            return NativeUtils.PtrToStringUtf8(GetMonitorNameInternal(monitor));
        }
