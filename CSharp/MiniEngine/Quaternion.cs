...
namespace MiniEngine
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="Quaternion"/> from the specified axis and angleRad.
        /// </summary>
        /// <param name="axis">The axis of rotation.</param>
        /// <param name="angleRad">The angleRad in radians.</param>
        /// <returns>The new quaternion builded from axis and angleRad.</returns>
        public static Quaternion CreateFromAxisAngle(Vector3 axis, float angleRad)
        {
            Quaternion quaternion;
            CreateFromAxisAngle(ref axis, angleRad, out quaternion);
            return quaternion;
        }
        ...
        /// <param name="axis">The axis of rotation.</param>
        /// <param name="angleRad">The angleRad in radians.</param>
        /// <param name="result">The new quaternion builded from axis and angleRad as an output parameter.</param>
        ...
        //public static void CreateFromRotationMatrix(ref Matrix4f matrix, out Quaternion result)
        //{
        //    float sqrt;
        //    float half;
        ...
        )
        {
            ...
            else
            {
                ...
                num2 = flag * (((float)Math.Sin((num * num5))) * num6);
            }
        ...
        public static Quaternion operator *(Quaternion quaternion, Vector3 vector)
        {
            ...
            Multiply(ref quaternion, ref vector, out quaternionOut);
