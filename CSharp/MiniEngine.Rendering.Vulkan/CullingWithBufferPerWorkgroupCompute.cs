...
namespace MiniEngine.Rendering.Vulkan
{
    ...
    /// Compute culling
    /// </summary>
    public class CullingWithBufferPerWorkgroupCompute : IRendererExtension
    {
        ...
        public void Init(IRenderer renderer)
        {
            ...
            var cullingShader = (VkShader)AssetManager.Current.Get<Shader>("Shaders/culling_buffer_per_workgroup.comp");
    ...
    public static class CullingWithBufferPerWorkgroupComputeExtensions
    {
        /// <summary>
        /// Add the culling compute extension
        /// </summary>
        public static T AddCullingWithBufferPerWorkgroupCompute<T>(this T renderer) where T : IRenderer
        {
            renderer.AddExtension(new CullingWithBufferPerWorkgroupCompute());
            return renderer;
        }
    }
}
