...
namespace MiniEngine.Rendering.Vulkan
{
    ...
    public unsafe class VkInstance: IDisposable
    {
        ...
        private void CreateSurface()
        {
            ...
            fixed (SurfaceKHR* ptrSurfaceKHR = &surface)
            {
                window.CreateSurface(instance.Handle, (IntPtr)ptrSurfaceKHR);
            }
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[{messageTypes}] validation layer:" + Marshal.PtrToStringAnsi((nint)pCallbackData->PMessage));
