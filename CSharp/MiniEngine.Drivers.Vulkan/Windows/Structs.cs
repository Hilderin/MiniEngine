...
namespace MiniEngine.Drivers.Vulkan.Windows
{
    unsafe public partial class Win32SurfaceCreateInfoKhr : MarshalledObject
    {
        ...
        internal MiniEngine.Drivers.Vulkan.Interop.Windows.Win32SurfaceCreateInfoKhr* m
        {

            get
            {
                return (MiniEngine.Drivers.Vulkan.Interop.Windows.Win32SurfaceCreateInfoKhr*)native.Handle;
            }
        }

        public Win32SurfaceCreateInfoKhr()
        {
            native = Vulkan.Interop.Structure.Allocate(typeof(MiniEngine.Drivers.Vulkan.Interop.Windows.Win32SurfaceCreateInfoKhr));
            Initialize();
        }
    ...
    unsafe public partial class ImportMemoryWin32HandleInfoNv : MarshalledObject
    {
        ...
        internal MiniEngine.Drivers.Vulkan.Interop.Windows.ImportMemoryWin32HandleInfoNv* m
        {

            get
            {
                return (MiniEngine.Drivers.Vulkan.Interop.Windows.ImportMemoryWin32HandleInfoNv*)native.Handle;
            }
        }

        public ImportMemoryWin32HandleInfoNv()
        {
            native = Vulkan.Interop.Structure.Allocate(typeof(MiniEngine.Drivers.Vulkan.Interop.Windows.ImportMemoryWin32HandleInfoNv));
            Initialize();
        }
    ...
    unsafe public partial class ExportMemoryWin32HandleInfoNv : MarshalledObject
    {
        ...
        internal MiniEngine.Drivers.Vulkan.Interop.Windows.ExportMemoryWin32HandleInfoNv* m
        {

            get
            {
                return (MiniEngine.Drivers.Vulkan.Interop.Windows.ExportMemoryWin32HandleInfoNv*)native.Handle;
            }
        }

        public ExportMemoryWin32HandleInfoNv()
        {
            native = Vulkan.Interop.Structure.Allocate(typeof(MiniEngine.Drivers.Vulkan.Interop.Windows.ExportMemoryWin32HandleInfoNv));
            Initialize();
        }
    ...
    unsafe public partial class Win32KeyedMutexAcquireReleaseInfoNv : MarshalledObject
    {
        ...
        internal MiniEngine.Drivers.Vulkan.Interop.Windows.Win32KeyedMutexAcquireReleaseInfoNv* m
        {

            get
            {
                return (MiniEngine.Drivers.Vulkan.Interop.Windows.Win32KeyedMutexAcquireReleaseInfoNv*)native.Handle;
            }
        }

        public Win32KeyedMutexAcquireReleaseInfoNv()
        {
            native = Vulkan.Interop.Structure.Allocate(typeof(MiniEngine.Drivers.Vulkan.Interop.Windows.Win32KeyedMutexAcquireReleaseInfoNv));
            Initialize();
        }
